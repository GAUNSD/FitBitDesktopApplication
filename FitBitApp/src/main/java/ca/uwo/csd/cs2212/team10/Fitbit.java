...
import com.github.scribejava.core.oauth.OAuth ;
...
public class AppRefreshTokens
{
	...
	public static void main (String [] args)
	{
		...
		try
		{
			...
			FileReader fileReader = new FileReader("/Users/pears/Documents/University/Year 2/Semester 2/CS2212/team10/FitBitApp/src/main/resources/Team10Tokens.txt");
			bufferedReader = new BufferedReader(fileReader);
			accessTokenItself = bufferedReader.readLine();
			tokenType = bufferedReader.readLine();
			refreshToken = bufferedReader.readLine();
			expiresIn = bufferedReader.readLine();
		...
		OAuthRequest request = new OAtuthRequest(Verb.GET, requestURL, service);
