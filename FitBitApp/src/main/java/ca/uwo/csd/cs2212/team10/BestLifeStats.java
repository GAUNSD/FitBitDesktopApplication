...
public class BestLifeStats
{
	...
	{
		return "BestStats [bestDistance = " + bestDistance + ", bestDistanceDate = " + bestDistanceDate
				+ ", bestFloor = " + bestFloor + ", bestFloorDate = " + bestFloorDate + ", bestStep = " + bestStep
				+ ", bestStepDate = " + bestStepDate + "]" + "\nLifeStats [lifeDistance = " + lifeDistance
				+ ", lifeFloors = " + lifeFloors + ", lifeSteps = " + lifeSteps + "]";
	}
